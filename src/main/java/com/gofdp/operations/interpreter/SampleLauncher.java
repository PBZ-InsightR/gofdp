...
class SampleLauncher {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("interpreting show actor for title <training day>: " + dvdInterpreterClient.interpret("show actor for title <Training Day>"));
        System.out.println("interpreting show title: " + dvdInterpreterClient.interpret("show title"));
        System.out.println("interpreting show title for actor <Ethan Hawke>: " + dvdInterpreterClient.interpret("show title for actor <Ethan Hawke>"));
    }
}      